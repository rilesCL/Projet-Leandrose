...
export default function UploadStageEmployeur({ employeurId }) {
    ...
    // ✅ Only disable submit button after success, not whole form
    const isSubmitDisabled = submitting || (toast.show && toast.type === 'success');
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <textarea
                                ...
                                disabled={submitting}
                                className={`mt-1 block w-full rounded-md border px-3 py-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition resize-none ${errors.description ? "border-red-400 bg-red-50" : "border-gray-300 bg-white"} ${submitting ? "opacity-50 cursor-not-allowed" : ""}`}
                            />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <DatePicker
                                    ...
                                    dropdownMode="select"
                                    disabled={submitting}
                                    className={`mt-1 block w-full rounded-md border px-3 py-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition ${errors.startDate ? "border-red-400 bg-red-50" : "border-gray-300 bg-white"} ${submitting ? "opacity-50 cursor-not-allowed" : ""}`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    disabled={submitting}
                                    className={`mt-1 block w-full rounded-md border px-3 py-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition ${errors.duration ? "border-red-400 bg-red-50" : "border-gray-300 bg-white"} ${submitting ? "opacity-50 cursor-not-allowed" : ""}`}
                                />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                disabled={submitting}
                                className={`mt-1 block w-full rounded-md border px-3 py-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition ${errors.address ? "border-red-400 bg-red-50" : "border-gray-300 bg-white"} ${submitting ? "opacity-50 cursor-not-allowed" : ""}`}
                            />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    step="0.01"
                                    disabled={submitting}
                                    className={`mt-1 block w-full rounded-md border px-3 py-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition ${errors.remuneration ? "border-red-400 bg-red-50" : "border-gray-300 bg-white"} ${submitting ? "opacity-50 cursor-not-allowed" : ""}`}
                                />
                        ...
                        <div>
                            ...
                            <div className="mt-1 flex items-center gap-3">
                                <label
                                    htmlFor="pdfFile"
                                    className={`inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white ${submitting ? "bg-indigo-400 cursor-not-allowed" : "bg-indigo-600 hover:bg-indigo-700 cursor-pointer"}`}
                                >
                                    {t("uploadStageEmployeur.choosePdf")}
                                </label>
                                <input id="pdfFile" type="file" accept="application/pdf" onChange={handleFileChange} disabled={submitting} className="hidden" />
                                    ...
                                    {pdfFile ? (
                                        <div className="flex items-center justify-between gap-3">
                                            ...
                                            <button
                                                ...
                                                onClick={clearFile}
                                                disabled={submitting}
                                                className={`text-sm text-red-600 ${submitting ? "opacity-50 cursor-not-allowed" : "hover:underline"}`}
                                            >
                        ...
                        <div className="flex flex-row gap-4 pt-4">
                            <button
                                ...
                                className={`inline-flex items-center justify-center gap-2 w-full md:w-auto px-6 py-3 border border-transparent text-sm font-medium rounded-md shadow-sm text-white ${isSubmitDisabled ? "bg-indigo-400 cursor-not-allowed" : "bg-indigo-600 hover:bg-indigo-700"} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition`}
                            >
                                {submitting && (
                        ...
                        {toast.show && (
                            <div
                                className={`mt-4 p-3 rounded-md text-sm ${toast.type === "success"
