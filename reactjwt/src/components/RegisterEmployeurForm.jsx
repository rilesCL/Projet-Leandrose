    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="max-w-3xl w-full bg-white rounded-lg shadow-md p-6 md:p-10">
                <h1 className="text-2xl font-semibold text-gray-800 mb-2">Inscription Employeur</h1>
                <p className="text-sm text-gray-500 mb-6">Créez un compte employeur pour publier des offres et gérer vos candidats.</p>
