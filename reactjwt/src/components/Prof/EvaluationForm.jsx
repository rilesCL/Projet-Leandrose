    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            ...
            <section className="mb-8 p-4 border rounded-lg bg-gray-50">
                ...
                <p className="text-gray-700"><strong className="text-gray-900">{t('evaluation.name')}</strong> {info?.entrepriseTeacherDto.companyName}</p>
                <p className="text-gray-700"><strong className="text-gray-900">{t('evaluation.contact_person')}</strong> {info?.entrepriseTeacherDto.contactName}</p>
                <p className="text-gray-700"><strong className="text-gray-900">{t('evaluation.address')}</strong> {info?.entrepriseTeacherDto.address}</p>
                <p className="text-gray-700"><strong className="text-gray-900">{t('evaluation.email')}</strong> {info?.entrepriseTeacherDto.email}</p>
            </section>

            {/* Student Info */}
            <section className="mb-8 p-4 border rounded-lg bg-gray-50">
                <h2 className="text-xl font-semibold mb-4 text-gray-900">{t('evaluation.studentInfo')}</h2>
                <p className="text-gray-700"><strong className="text-gray-900">{t('evaluation.name')}</strong> {info?.studentTeacherDto.fullname}</p>
                <p className="text-gray-700"><strong className="text-gray-900">{t('evaluation.internStartDate')}</strong> {info?.studentTeacherDto.internshipStartDate}</p>
            </section>
            ...
            {Object.entries(teacherEvaluationTemplate).map(([groupKey, group]) => (
                <section key={groupKey} className="mb-8 p-4 border rounded-lg bg-white">
                    ...
                    <h3 className="text-lg font-semibold mb-4 text-gray-900">{t(`evaluation.${groupKey}.title`)}</h3>
            ...
            <section className="mb-8 p-4 border rounded-lg bg-gray-50">
                <h3 className="text-lg font-semibold mb-4 text-gray-900">{t("evaluation.observations.title")}</h3>
                ...
                <div className="mb-6">
                    ...
                    <p className="font-medium mb-2 text-gray-700">{t("evaluation.observations.q1")}</p>
                    <div className="flex flex-wrap justify-center gap-3">
                ...
                <div className="mb-6">
                    ...
                    <p className="font-medium mb-2 text-gray-700">{t("evaluation.observations.q2")}</p>
                    <div className="flex flex-wrap justify-center gap-3">
                        {[
                ...
                <div className="mb-6">
                    ...
                    <p className="font-medium mb-2 text-gray-700">{t("evaluation.observations.q3")}</p>
