...
class CredentialsTest {
  ...
  void testUserDetailsFlags() {
    Credentials creds =
        Credentials.builder().email("x@y.com").password("pwd").role(Role.STUDENT).build();
  ...
  void testToString() {
    Credentials creds =
        Credentials.builder().email("toString@test.com").password("pwd").role(Role.STUDENT).build();
  ...
  void testEqualsAndHashCode() {
    Credentials c1 =
        Credentials.builder().email("same@example.com").password("123").role(Role.STUDENT).build();
