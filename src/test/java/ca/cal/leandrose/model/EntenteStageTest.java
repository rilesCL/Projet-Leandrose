...
class EntenteStageTest {
  ...
  void testStatutEntenteEnum() {
    ...
    assertEquals(
        EntenteStage.StatutEntente.BROUILLON, EntenteStage.StatutEntente.valueOf("BROUILLON"));
    assertEquals(
        EntenteStage.StatutEntente.EN_ATTENTE_SIGNATURE,
        EntenteStage.StatutEntente.valueOf("EN_ATTENTE_SIGNATURE"));
