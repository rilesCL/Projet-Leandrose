...
class EvaluationStagiaireServiceTest {
  ...
  @InjectMocks private EvaluationStagiaireService evaluationStagiaireService;
  ...
  void setUp() {
    ...
    evaluationStagiaire =
        EvaluationStagiaire.builder()
            ...
            .build();
    candidature =
        Candidature.builder().id(1L).student(student).internshipOffer(internshipOffer).build();
  }
  ...
  void createEvaluation_EvaluationAlreadyExists_ThrowsException() {
    ...
    assertEquals(
        "Une évaluation existe déjà pour ce stagiaire et ce stage", exception.getMessage());
    verify(evaluationStagiaireRepository).existsByInternshipOfferIdAndStudentId(3L, 2L);
  ...
  void createEvaluation_EmployeurNotFound_ThrowsException() {
    ...
    RuntimeException exception =
        assertThrows(
            RuntimeException.class, () -> evaluationStagiaireService.createEvaluation(1L, 2L, 3L));
  ...
  void getEvaluationInfo_NotEligible_ThrowsException() {
    ...
    assertEquals(
        "Evaluation not allowed - agreement not validated or not found", exception.getMessage());
    verify(ententeStageRepository)
        .findByCandidature_Student_IdAndCandidature_InternshipOffer_IdAndStatut(
            2L, 3L, EntenteStage.StatutEntente.VALIDEE);
    verify(evaluationStagiaireRepository, never())
        .existsByInternshipOfferIdAndStudentId(anyLong(), anyLong());
  }
  ...
  void getEvaluationInfo_StudentNotFound_ThrowsException() {
    ...
    RuntimeException exception =
        assertThrows(
            RuntimeException.class, () -> evaluationStagiaireService.getEvaluationInfo(1L, 2L, 3L));
  ...
  void getEvaluationById_NotFound_ThrowsException() {
    ...
    RuntimeException exception =
        assertThrows(
            RuntimeException.class, () -> evaluationStagiaireService.getEvaluationById(1L));
  ...
  void getEvaluationsByEmployeur_Success() {
    // Given
    EvaluationStagiaire evaluation2 =
        EvaluationStagiaire.builder()
            .id(2L)
            .dateEvaluation(LocalDate.now())
            .employeur(employeur)
