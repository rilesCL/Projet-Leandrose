...
class EntenteStageServiceTest {
  ...
  @InjectMocks private EntenteStageService ententeStageService;
  ...
  void testCreerEntente_CandidatureIdNull() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> ententeStageService.creerEntente(ententeDto));
  }
  ...
  void testModifierEntente_Success() {
    ...
    EntenteStageDto modificationDto = EntenteStageDto.builder().remuneration(350f).build();
  ...
  void signerParEmployeur_EntenteNotFound() {
    ...
    assertThrows(
        EntityNotFoundException.class,
        () -> ententeStageService.signerParEmployeur(1L, employeur.getId()));
  }
  ...
  void signerParEmployeur_WrongEmployeur_Throws() {
    ...
    when(ententeRepository.findById(1L)).thenReturn(Optional.of(entente));
    assertThrows(
        IllegalArgumentException.class, () -> ententeStageService.signerParEmployeur(1L, 99L));
  }
  ...
  void signerParEtudiant_WrongStudent_Throws() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> ententeStageService.signerParEtudiant(1L, 99L));
  }
